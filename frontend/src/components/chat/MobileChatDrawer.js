...
const MobileChatDrawer = React.forwardRef(({ isOpen, onClose, onNewChat, onDeleteSuccess }, ref) => {
  // 使用Map存储对话数据
  ...
  }, [navigate, currentSessionId, onClose]);
  ...
  return (
    <>
      ...
      {/* 抽屉内容 */}
      <div className={`fixed top-0 left-0 h-full w-80 max-w-[85vw] bg-white z-50 transform transition-transform duration-300 ease-out md:hidden ${
...
export default React.memo(MobileChatDrawer, (prevProps, nextProps) => {
  return (
